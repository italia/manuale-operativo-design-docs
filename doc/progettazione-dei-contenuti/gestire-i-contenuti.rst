...
Una corretta gestione dei contenuti è fondamentale anche per la gestione di attività "straordinarie", come la `migrazione dei contenuti <../../doc/progettazione-dei-contenuti/gestire-i-contenuti.html#migrare-i-contenuti>`_  ad un nuovo sito web, o la `traduzione di una parte dei contenuti <../../doc/progettazione-dei-contenuti/scrittura-e-linguaggio.html#traduzione-e-localizzazione-dei-contenuti>`_ del proprio sito.
